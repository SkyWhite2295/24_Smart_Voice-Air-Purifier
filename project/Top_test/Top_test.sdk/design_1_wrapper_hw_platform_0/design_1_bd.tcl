...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set asr_rx [ create_bd_port -dir I asr_rx ]
  set asr_tx [ create_bd_port -dir I asr_tx ]
  set cs [ create_bd_port -dir O cs ]
  set dc [ create_bd_port -dir O dc ]
  set dht11_data [ create_bd_port -dir IO dht11_data ]
  set dht11_data_o [ create_bd_port -dir IO dht11_data_o ]
  set jq_rx [ create_bd_port -dir I jq_rx ]
  set pm_o_rx [ create_bd_port -dir I pm_o_rx ]
  set pm_rx [ create_bd_port -dir I pm_rx ]
  set res [ create_bd_port -dir O res ]
  set sclk [ create_bd_port -dir O sclk ]
  set sda [ create_bd_port -dir O sda ]
  set tts_tx [ create_bd_port -dir O tts_tx ]

  # Create instance: ASR, and set properties
  set ASR [ create_bd_cell -type ip -vlnv xilinx.com:user:ASR_rcv:1.0 ASR ]

  # Create instance: CH2O, and set properties
  set CH2O [ create_bd_cell -type ip -vlnv xilinx.com:user:jiaquan:1.0 CH2O ]

  # Create instance: DHT11, and set properties
  set DHT11 [ create_bd_cell -type ip -vlnv xilinx.com:user:DHT11_IP:1.0 DHT11 ]

  # Create instance: DHT11_outdoor, and set properties
  set DHT11_outdoor [ create_bd_cell -type ip -vlnv xilinx.com:user:DHT11_IP:1.0 DHT11_outdoor ]

  # Create instance: Motor, and set properties
  set Motor [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Motor ]
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {1}  ] $Motor
  ...
  # Create instance: PM_outdoor, and set properties
  set PM_outdoor [ create_bd_cell -type ip -vlnv xilinx.com:user:PM:1.0 PM_outdoor ]

  # Create instance: asrUART, and set properties
  set asrUART [ create_bd_cell -type ip -vlnv xilinx.com:user:myipUART:1.0 asrUART ]

  # Create instance: ch2oUART_1, and set properties
  set ch2oUART_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:myipUART:1.0 ch2oUART_1 ]

  # Create instance: pmUART, and set properties
  set pmUART [ create_bd_cell -type ip -vlnv xilinx.com:user:myipUART:1.0 pmUART ]

  # Create instance: pmoutdoorUART, and set properties
  set pmoutdoorUART [ create_bd_cell -type ip -vlnv xilinx.com:user:myipUART:1.0 pmoutdoorUART ]
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  set_property -dict [ list CONFIG.NUM_MI {13}  ] $processing_system7_0_axi_periph
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports GPIO] [get_bd_intf_pins Motor/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins PM/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins ASR/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins asrUART/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI] [get_bd_intf_pins tts/uart_tx]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins CH2O/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins DHT11/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M07_AXI [get_bd_intf_pins pmUART/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M08_AXI [get_bd_intf_pins ch2oUART_1/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M09_AXI [get_bd_intf_pins Motor/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M10_AXI [get_bd_intf_pins PM_outdoor/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M11_AXI [get_bd_intf_pins pmoutdoorUART/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M12_AXI [get_bd_intf_pins DHT11_outdoor/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M12_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports dht11_data] [get_bd_pins DHT11/dht11_data]
  connect_bd_net -net Net1 [get_bd_ports dht11_data_o] [get_bd_pins DHT11_outdoor/dht11_data]
  ...
  connect_bd_net -net UART_LITE_TX_0_tx [get_bd_ports tts_tx] [get_bd_pins tts/tx]
  connect_bd_net -net myipUART_0_message [get_bd_pins PM/message_mid] [get_bd_pins pmUART/message]
  connect_bd_net -net myipUART_0_message1 [get_bd_pins PM_outdoor/message_mid] [get_bd_pins pmoutdoorUART/message]
  connect_bd_net -net myipUART_0_over [get_bd_pins PM/over] [get_bd_pins pmUART/over]
  connect_bd_net -net myipUART_0_over1 [get_bd_pins PM_outdoor/over] [get_bd_pins pmoutdoorUART/over]
  connect_bd_net -net myipUART_1_message [get_bd_pins CH2O/message_mid1] [get_bd_pins ch2oUART_1/message]
  connect_bd_net -net myipUART_1_over [get_bd_pins CH2O/over] [get_bd_pins ch2oUART_1/over]
  connect_bd_net -net myipUART_2_message [get_bd_pins ASR/rcv_msg] [get_bd_pins asrUART/message]
  connect_bd_net -net myipUART_2_over [get_bd_pins ASR/over] [get_bd_pins asrUART/over]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ASR/s00_axi_aclk] [get_bd_pins CH2O/s00_axi_aclk] [get_bd_pins DHT11/s00_axi_aclk] [get_bd_pins DHT11_outdoor/s00_axi_aclk] [get_bd_pins Motor/s_axi_aclk] [get_bd_pins OLED/spi_mosi_aclk] [get_bd_pins PM/s00_axi_aclk] [get_bd_pins PM_outdoor/s00_axi_aclk] [get_bd_pins asrUART/s00_axi_aclk] [get_bd_pins ch2oUART_1/s00_axi_aclk] [get_bd_pins pmUART/s00_axi_aclk] [get_bd_pins pmoutdoorUART/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/M08_ACLK] [get_bd_pins processing_system7_0_axi_periph/M09_ACLK] [get_bd_pins processing_system7_0_axi_periph/M10_ACLK] [get_bd_pins processing_system7_0_axi_periph/M11_ACLK] [get_bd_pins processing_system7_0_axi_periph/M12_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins tts/uart_tx_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins ASR/s00_axi_aresetn] [get_bd_pins CH2O/s00_axi_aresetn] [get_bd_pins DHT11/s00_axi_aresetn] [get_bd_pins DHT11_outdoor/s00_axi_aresetn] [get_bd_pins Motor/s_axi_aresetn] [get_bd_pins OLED/spi_mosi_aresetn] [get_bd_pins PM/s00_axi_aresetn] [get_bd_pins PM_outdoor/s00_axi_aresetn] [get_bd_pins asrUART/s00_axi_aresetn] [get_bd_pins ch2oUART_1/s00_axi_aresetn] [get_bd_pins pmUART/s00_axi_aresetn] [get_bd_pins pmoutdoorUART/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M09_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M10_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M11_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M12_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins tts/uart_tx_aresetn]
  connect_bd_net -net rx_1 [get_bd_ports pm_rx] [get_bd_pins pmUART/rx]
  connect_bd_net -net rx_2 [get_bd_ports jq_rx] [get_bd_pins ch2oUART_1/rx]
  connect_bd_net -net rx_3 [get_bd_ports asr_rx] [get_bd_pins asrUART/rx]
  connect_bd_net -net rx_4 [get_bd_ports pm_o_rx] [get_bd_pins pmoutdoorUART/rx]
  connect_bd_net -net tx_1 [get_bd_ports asr_tx] [get_bd_pins ASR/tx]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ASR/S00_AXI/S00_AXI_reg] SEG_ASR_rcv_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DHT11/S00_AXI/S00_AXI_reg] SEG_DHT11_IP_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43CB0000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DHT11_outdoor/S00_AXI/S00_AXI_reg] SEG_DHT11_outdoor_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Motor/S_AXI/Reg] SEG_Motor_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PM/S00_AXI/S00_AXI_reg] SEG_PM_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C90000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PM_outdoor/S00_AXI/S00_AXI_reg] SEG_PM_outdoor_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs tts/uart_tx/uart_tx_reg] SEG_UART_LITE_TX_0_uart_tx_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs asrUART/S00_AXI/S00_AXI_reg] SEG_asrUART_2_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs CH2O/S00_AXI/S00_AXI_reg] SEG_jiaquan_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C80000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ch2oUART_1/S00_AXI/S00_AXI_reg] SEG_jqUART_1_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C70000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pmUART/S00_AXI/S00_AXI_reg] SEG_pmUART_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43CA0000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pmoutdoorUART/S00_AXI/S00_AXI_reg] SEG_pmoutdoorUART_S00_AXI_reg
