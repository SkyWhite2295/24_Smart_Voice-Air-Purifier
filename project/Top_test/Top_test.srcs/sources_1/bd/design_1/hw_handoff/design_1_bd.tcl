...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_net -net asrUART_message [get_bd_pins ASR/rcv_msg] [get_bd_pins asrUART/message]
  connect_bd_net -net asrUART_over [get_bd_pins ASR/over] [get_bd_pins asrUART/over]
  connect_bd_net -net asr_tx_1 [get_bd_ports asr_tx] [get_bd_pins ASR/tx]
